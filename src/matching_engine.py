...
class MatchingEngine:
    ...
    def process_order(self, incoming_order: Order, side: str) -> list[Trade]:
        ...
        if side == 'buy':
            ...
            while incoming_order.quantity > 0 and self.order_book.asks and incoming_order.price >= self.order_book.asks[0].price:
            ...
            while incoming_order.quantity > 0 and self.order_book.bids and incoming_order.price <= self.order_book.bids[0].price:
